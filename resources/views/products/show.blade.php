                    ...
                    <div class="mt-6 sm:mt-8 lg:mt-0">
                        ...
                        <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                            <a href="{{ route('products.index') }}" title=""
                                class="flex items-center justify-center py-2.5 px-5 text-sm font-medium text-white focus:outline-none bg-red-600 rounded-lg border border-red-600 hover:bg-red-700 focus:z-10 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-700"
                                role="button">
                                <svg class="w-5 h-5 -ms-2 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M12 2L2 12h3v8h6v-6h4v6h6v-8h3L12 2z" />
                                </svg>
                                Back to Products
                            </a>
                        </div>
